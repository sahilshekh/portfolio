...
// *=============================== github calender ==================================
    GitHubCalendar(".calendar", "sahilshekh");

    // or enable responsive functionality:
    GitHubCalendar(".calendar", "sahilshekh", { responsive: true });
...
// *=============================== resume open in new tab ==================================
    ...
    function NewTab() {
      window.open(
        "https://drive.google.com/file/d/1RMQ9lL86J2E5kOvF-GDt9kbA7_vz95Ex/view"
      );
    }
